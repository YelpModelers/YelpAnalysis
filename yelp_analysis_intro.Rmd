...
output: pdf_document
author: Claire Yang, Hayden Sansum, Nikhil Vanderklaauw
fig_caption: yes
header-includes:
 \usepackage{float}
...
knitr::kable(summary(data.frame(popularity)))
...
category_df <- category_df[order(category_df$Frequency, decreasing = TRUE),]
knitr::kable(category_df[1:15,])
```
...
```{r fig4, fig.height = 3.5, fig.width = 13, echo=FALSE}
par(mfrow=c(1,3))
hist(vy$cool_review_pm, main="", xlab="'cool' vote reviews per month")
hist(vy$funny_review_pm, main="", xlab="'funny' vote reviews per month")
hist(vy$useful_review_pm, main="", xlab="'useful' vote reviews per month")

output_df_rev <- data.frame(cool_review = as.numeric(summary(vy$cool_review_pm)), funny_review = as.numeric(summary(vy$funny_review_pm)), useful_review = as.numeric(summary(vy$useful_review_pm)), row.names = names(summary(vy$cool_review_pm)))

knitr::kable(output_df_rev)

plot(popularity_log~cool_review_pm, data=vy, xlab="'cool' vote reviews per month", ylab="log (popularity)")
plot(popularity_log~funny_review_pm, data=vy, xlab="'funny' vote reviews per month", ylab="log (popularity)")
plot(popularity_log~useful_review_pm, data=vy, xlab="'useful' vote reviews per month", ylab="log (popularity)")

plot(popularity_log~log(cool_review_pm), data=vy, xlab="log ('cool' vote reviews per month)", main="Predictor log-transformed", ylab="log (popularity)")
plot(popularity_log~log(funny_review_pm), data=vy, xlab="log ('funny' vote reviews per month)", main="Predictor log-transformed", ylab="log (popularity)")
plot(popularity_log~log(useful_review_pm), data=vy, xlab="log ('useful' vote reviews per month)", main="Predictor log-transformed", ylab="log (popularity)")
```
...
```{r fig11, fig.height = 4.2, fig.width = 12, echo=FALSE}
par(mfrow=c(1,2))
hist(vy$elite_users_sum, main="", xlab="Number of elite-status reviewers for a business")
hist(vy$review_users_mean, main="", xlab="Mean number of reviews written by reviewers of a business")
#summary(vy$elite_users_sum)
#summary(vy$review_users_mean)

plot(popularity_log~elite_users_sum, data=vy, xlab="Number of elite-status reviewers for a business", ylab="log (popularity)")
plot(popularity_log~review_users_mean, data=vy, xlab="Mean number of reviews written by reviewers of a business", ylab="log (popularity)")

plot(popularity_log~log(elite_users_sum), data=vy, xlab="log (Number of elite-status reviewers for a business)", main="Predictor log-transformed", ylab="log (popularity)")
plot(popularity_log~log(review_users_mean), data=vy, xlab="log (Mean number of reviews written by reviewers of a business)", main="Predictor log-transformed", ylab="log (popularity)")
...
```{r fig12, fig.height = 4.2, fig.width = 5, echo=FALSE}
plot(popularity_log~log(elite_users_sum/review_count_business), data=vy, xlab="log (elite-status reviewers / #reviews)", ylab="log (popularity)")
```
...
par(mfrow=c(1,2))
hist(vy$fans_users_mean, main="", xlab="Mean number of fans reviewers of a business have")
hist(vy$friend_number_mean, main="", xlab="Mean number of friends reviewers of a business have")
#summary(vy$fans_users_mean)
#summary(vy$friend_number_mean)

plot(popularity_log~fans_users_mean, data=vy, xlab="Mean number of fans reviewers of a business have", ylab="log (popularity)")
plot(popularity_log~friend_number_mean, data=vy, xlab="Mean number of friends reviewers of a business have", ylab="log (popularity)")

plot(popularity_log~log(fans_users_mean), data=vy, xlab="log (Mean number of fans reviewers of a business have)", main="Predictor log-transformed", ylab="log (popularity)")
plot(popularity_log~log(friend_number_mean), data=vy, xlab="log (Mean number of friends reviewers of a business have)", main="Predictor log-transformed", ylab="log (popularity)")
...
par(mfrow=c(1,2))
hist(vy$fan_outlier_count, main="", xlab="Number of reviewers with outlier fan counts for a business")
hist(vy$friend_outlier_count, main="", xlab="Number of reviewers with outlier friend counts for a business")
#summary(vy$fan_outlier_count)
#summary(vy$friend_outlier_count)

plot(popularity_log~fan_outlier_count, data=vy, xlab="Number of reviewers with outlier fan counts for a business", ylab="log (popularity)")
plot(popularity_log~friend_outlier_count, data=vy, xlab="Number of reviewers with outlier friend counts for a business", ylab="log (popularity)")

plot(popularity_log~log(fan_outlier_count), data=vy, xlab="log (Number of reviewers with outlier fan counts for a business)", main="Predictor log-transformed", ylab="log (popularity)")
plot(popularity_log~log(friend_outlier_count), data=vy, xlab="log (Number of reviewers with outlier friend counts for a business)", main="Predictor log-transformed", ylab="log (popularity)")
...
par(mfrow=c(1,2))
plot(popularity_log~log(fan_outlier_count/review_count_business), data=vy, xlab="log (Number of reviewers with outlier fan counts for a business / Number of reviews)", ylab="log (popularity)")

plot(popularity_log~log(friend_outlier_count/review_count_business), data=vy, xlab="log (Number of reviewers with outlier friend counts for a business / Number of reviews)", ylab="log (popularity)")
