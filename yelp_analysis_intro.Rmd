...
In order to begin modelling we first had to combine all these tables into a clean dataset. To do this though as the tables were too large to keep in memory we decided to cut down the scope from all USA food businesses
...
```{r fig4, fig.height = 3.5, fig.width = 14}
par(mfrow=c(1,3))
...
```{r fig11, fig.height = 3.5, fig.width = 14}
par(mfrow=c(1,2))
...
```{r fig12, fig.height = 3.5, fig.width = 5}
...
```{r fig13, fig.height = 3.5, fig.width = 14}
par(mfrow=c(1,2))
...
```{r fig14, fig.height = 3.5, fig.width = 14}
par(mfrow=c(1,2))
...
```{r fig15, fig.height = 3.5, fig.width = 14}
par(mfrow=c(1,2))
...
```{r fig16, fig.height = 10, fig.width = 10}
